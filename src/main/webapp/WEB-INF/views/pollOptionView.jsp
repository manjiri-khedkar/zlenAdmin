	...
	<div id="wrapper">
			<div class="container">
				<div class="clearfix">&nbsp;</div>                        
       				<form:form action="${pageContext.request.contextPath}/pollOptionView/{id}" id="table1" method="post"  modelAttribute="pollOption">
       
			   			<div class="panel-heading">
							<h2 class="text-center" style="color: black;"><b>View All Poll Options</b></h2>
						</div><br/>
...
<!-- 											 <th class="text-left" style="background: #d3d3d3">Date</th>			 -->
									  ...
									  <tbody>
										...
										<c:forEach items="${podList}"  var="list" varStatus="status"> 
		 	                        		<tr class="odd gradeX"> 
