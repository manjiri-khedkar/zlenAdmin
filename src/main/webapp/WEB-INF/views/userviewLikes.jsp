	...
	<div id="wrapper">
			<div class="container">
				<div class="clearfix">&nbsp;</div>                        
       				<form:form action="${pageContext.request.contextPath}/userviewLikes/{id}" id="table1" method="post"  modelAttribute="userLikes">
       
			   			<div class="panel-heading">
							<h2 class="text-center" style="color: black;"><b>View All Likes</b></h2>
						</div><br/>
								...
								<table id="table1" class="table info-tbl text-left" style='border: 1px solid #d3d3d3;width: 98% !important; '>
									<thead>
									  ...
									  <tbody>
										...
										<c:forEach items="${userLikes}"  var="list" varStatus="status"> 
		 	                        		<tr class="odd gradeX"> 
