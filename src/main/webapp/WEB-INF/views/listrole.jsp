...
<div id="wrapper">
	<jsp:include page="header.jsp"></jsp:include>
   		<div class="container">
	   		...
	   		<div class="row">
		         <div class="col-md-12">
		         	<a href="role/addRole"><button type="button" name="b10" class="btn btn-primary" title="Add New Role">Add</button></a>
	            </div>
	        </div>
	        <br>
						...
						<table id="table1" class="table info-tbl text-left" style='border: 1px solid #d3d3d3;width: 98% !important; '>
                        	...
                        	<c:forEach items="${roleList}" var="list" varStatus="status">
	                        	<tr class="odd gradeX">
									...
									<td><a href="/role/editRole/<c:out value='${list.id}'/>"><button class="btn btn-primary"><i class="fa fa-edit"></i></button></a>&nbsp;
										<a href="/role/deleteRole/${list.id}" onclick="'return confirm(\'Are you sure to Delete Record?\');'" ><button class="btn btn-primary" ><i class="fa fa-trash"></i></button></a>
									</td>
