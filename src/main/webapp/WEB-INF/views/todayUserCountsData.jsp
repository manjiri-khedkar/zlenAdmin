	...
	<div id="wrapper">
			<div class="container">
				<div class="clearfix">&nbsp;</div>                        
       				<form:form action="${pageContext.request.contextPath}/todayUserCountsData" id="table1" method="post"  modelAttribute="todayUserCountsData">
       					
			   			<div class="panel-heading">
						<br>
							<h2 class="text-center" style="color: black;"><b>Today Active User Data View</b></h2>
						</div><br/>
...
<!-- 											 <th class="text-left" style="background: #d3d3d3">Date</th>			 -->
									  ...
									  <tbody>
										...
										<c:forEach items="${todayUserCountsDatalist}"  var="list" varStatus="status"> 
		 	                        		<tr class="odd gradeX"> 
